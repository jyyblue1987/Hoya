		 ...
		 function setOptionState(){
			if(optVal.selIndoor==true ){
				...
				if(optVal.age40below==true){
					...
					$("#image_si_back").attr("-webkit-filter","blur(0px)").attr("filter","blur(0px)");
					$("#image_ipad").attr("-webkit-filter","blur(0px)").attr("filter","blur(0px)");
				}
				else{
					if(optVal.sel40plus==1){
						...
						switch(optVal.vCond){
						    case 1: $("#simulator-backimg").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");$("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
									...
									//$("#image_ipad").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");
									document.getElementById("image_si_back").style.filter="blur(0px)";
									document.getElementById("image_ipad").style.filter="blur(2.5px)";
									//$("#image_si_back").attr("-webkit-filter","blur(0px)").attr("filter","blur(0px)");
									//$("#image_ipad").attr("-webkit-filter","blur(2.5px)").attr("filter","blur(2.5px)");
						    ...
						    case 2: $("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");$("#ipad-backimg").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");
								    $("#image_si_back").attr("-webkit-filter","blur(5px)").attr("filter","blur(5px)");
									$("#image_ipad").attr("-webkit-filter","blur(0px)").attr("filter","blur(0px)");
								    break;
				...
				if(optVal.age40below==true){
					switch(optVal.vCond){
					    case 1:if(optVal.selPC==0){   
						           $("#simulator-backimg").css("-webkit-filter","blur(5px)brightness(100%)").css("filter","blur(5px)brightness(100%)");
								   $("#ipad-backimg").css("-webkit-filter","blur(0px)brightness(100%)").css("filter","blur(0px)brightness(100%)");
							   }else{
						...
						case 2:if(optVal.selPC==0){
     						       $("#simulator-backimg").css("-webkit-filter","blur(0px)brightness(100%)").css("filter","blur(0px)brightness(100%)");
								   $("#ipad-backimg").css("-webkit-filter","blur(0px)brightness(100%)").css("filter","blur(0px)brightness(100%)");
						       }else{
								   $("#simulator-backimg").css("-webkit-filter","blur(0px)brightness(110%)").css("filter","blur(0px)brightness(110%)");
								   $("#ipad-backimg").css("-webkit-filter","blur(0px)brightness(110%)").css("filter","blur(0px)brightness(110%)");
							   }
							   break;
