	...
	<script type="text/javascript"> 
		 ...
		 function setOptionState(){
			if(optVal.selIndoor==true ){//===Indoor
			    document.getElementById("simulator-backimg").src = "/models/timthumblens.php?src=/images/simulators/si_back.jpg&w="+imgw+"&h="+imgh;
			    document.getElementById("ipad-backimg").src = "/models/timthumblens.php?src=/images/simulators/ipad_C.png&w="+ipadw+"&h="+ipadh;
				imgURL = "/models/timthumblens.php?src=/images/simulators/si_back.jpg&w="+imgw+"&h="+imgh;
			    imgURLiPad = "/models/timthumblens.php?src=/images/simulators/ipad_C.png&w="+imgw+"&h="+imgh;

			 	if(optVal.age40below==true){
					switch(optVal.vCond){
					    case 1:$("#simulator-backimg").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");$("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");break;
						case 2:$("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");$("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");break;
						case 3:$("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");$("#ipad-backimg").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");break;
					}
					$("#image_si_back").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
					imgURLiPad = "/models/timthumblens.php?src=/images/simulators/ipad_C.png&w="+imgw+"&h="+imgh;
				}
				else{
					if(optVal.sel40plus==1){
						switch(optVal.vCond){
						    case 1:$("#simulator-backimg").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");$("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");break;
						    case 2:$("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");$("#ipad-backimg").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");break;
						    case 3:$("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");$("#ipad-backimg").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");break;
						}
						$("#image_si_back").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
						imgURLiPad = "/models/timthumblens.php?src=/images/simulators/ipad_C.png&w="+imgw+"&h="+imgh;
						...
						switch(optVal.vCond){
						    case 1: $("#simulator-backimg").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
							        $("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
								    $("#image_si_back").css("filter","blur(0px)").css("-webkit-filter","blur(0px)");
									imgURLiPad = "/models/timthumblens.php?src=/images/simulators/ipad_B.png&w="+imgw+"&h="+imgh;
									break;
						    case 2: $("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
							        $("#ipad-backimg").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");
								    $("#image_si_back").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
									imgURLiPad = "/models/timthumblens.php?src=/images/simulators/ipad_C.png&w="+imgw+"&h="+imgh;
									break;
						    case 3: $("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
							        $("#ipad-backimg").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");
								    $("#image_si_back").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
									imgURLiPad = "/models/timthumblens.php?src=/images/simulators/ipad_C.png&w="+imgw+"&h="+imgh;
							        break;
                 ...
                 document.getElementById("simulator-backimg").src = "/models/timthumblens.php?src=/images/simulators/outdoor_sun.jpg&w="+imgw+"&h="+imgh;
			     document.getElementById("ipad-backimg").src = "/models/timthumblens.php?src=/images/simulators/outdoor_ipadsun.png&w="+ipadw+"&h="+ipadh;
				 if(optVal.selPC==0){
					 imgURL = "/models/timthumblens.php?src=/images/simulators/outdoor_sun.jpg&w="+imgw+"&h="+imgh;
			         //imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipadsun.png&w="+imgw+"&h="+imgh;
			     }else{
					 imgURL = "/models/timthumblens.php?src=/images/simulators/outdoor.jpg&w="+imgw+"&h="+imgh;
			         //imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipad.png&w="+imgw+"&h="+imgh;
			     }
			     if(optVal.age40below==true){
					$("#image_si_back").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
					switch(optVal.vCond){
					    case 1:if(optVal.selPC==0){   
						           imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipadsun.png&w="+imgw+"&h="+imgh;
						           $("#simulator-backimg").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
								   $("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
							   }else{
								   imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipad.png&w="+imgw+"&h="+imgh;
								   $("#simulator-backimg").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
						...
						case 2:if(optVal.selPC==0){
							       imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipadsun.png&w="+imgw+"&h="+imgh;
     						       $("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
								   $("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
						       }else{
								   imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipad.png&w="+imgw+"&h="+imgh;
								   $("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
					...
					if(optVal.sel40plus==1){
						...
						switch(optVal.vCond){
						    case 1:$("#image_si_back").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
							       if(optVal.selPC==0){ 
								       imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipadsun_B.png&w="+imgw+"&h="+imgh;
							           $("#simulator-backimg").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
									   $("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
							       }else{
									   imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipad_B.png&w="+imgw+"&h="+imgh;
									   $("#simulator-backimg").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
									   $("#ipad-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
							       }
								    ...
								    break;
						    case 2:$("#image_si_back").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
							        if(optVal.selPC==0){
										imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipadsun.png&w="+imgw+"&h="+imgh;
							            $("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
										$("#ipad-backimg").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");
									...
									break;
						    case 3:$("#image_si_back").css("-webkit-filter","blur(5px)").css("filter","blur(5px)");
							       if(optVal.selPC==0){
									    imgURLiPad = "/models/timthumblens.php?src=/images/simulators/outdoor_ipadsun.png&w="+imgw+"&h="+imgh;
							            $("#simulator-backimg").css("-webkit-filter","blur(0px)").css("filter","blur(0px)");
										$("#ipad-backimg").css("-webkit-filter","blur(2.5px)").css("filter","blur(2.5px)");
		 ...
		 $(function(){ 
			 ...
			 setOption(1);
			 PositionOption();
					 $('#option-panelimg').css("height",imgh+"px");
		 ...
		 function setOption1(){
			initoption();
			$('#option-eyesightimg').attr("src","/images/simulators/option.png");
                        optVal.vCond=2;
						setOptionState();
		 }
		 var setageflag=0;
		 function setAge(){
			 if(setageflag==0){
				 if(imgw < 600){
					document.getElementById("option-ageslide").style.transform="translate(22px,0)";
				 }else{
		 ...
		 function setlifestyle(){
			 if(setlifeflag==0){
				 if(imgw < 600){
					document.getElementById("option-lifeslide").style.transform="translate(22px,0)";
				 }else{
		 ...
		 function suggestedshow(n){
			 if(n==1) {
				 ...
				 simulatorscreen = $(".container").height();
			...
			if(n==0) {
				...
				var newscreen = $("#suggested-lens").height();
				if(newscreen > simulatorscreen)
...
<div class="container container-simulator" style="position:relative;z-index:150;"><!--display:none-->
	    <a id="lens_img" href="" class="zoomple">
		   <div>
				...
				<img id="simulator-backimg1" src = "" style="min-width:100%;width:100%;height:100%;position:absolute;top:0px;left:0px;background: blue; opacity: 0.04;"/>
		...
		<div id="simulator-option" style=""><!--opacity:0.85;background: black;-->
	      <div id = "innersimulator" style="float:left;width:100%;height:auto;" > 
		    <!--<img id="option-panelimg" src = "/images/simulators/simulator.png" style="display:none"  alt="" />	-webkit-filter: blur(80px);filter: blur(80px);-->
		   <div id="option-panelimg"  style="float:left;width:100%;height:auto; z-index:1000;"  alt="" />	</div>
		   
           <div class="optionbar-bind" style="z-index:1010;">			
			 <div class="option-title" style="text=align:center;">
			      <h2 class="option_title11" style="    text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> SIMULATOR </h2>
			 </div>
			 <div class="option-vision">
				<div>
				  <ul><h3 class="option_title12" style="     text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> VISION CONDITION </h3></ul>
				  <ul><div class="option-myopia" style="clear:both;">
				      <div class="option-backimg">
					      <img id="option-myopiaimg" class="option-tempimg" src = "/images/simulators/option.png"  alt="" onClick="setOption(1)"/> 
					  </div>
					  <div class="myopia-text" style="margin-left:25px;">
					     <h4 class="option_title13" style="margin-bottom:0px;    text-shadow: rgb(0, 0, 0) 1px 1px 3px;">Short-sighted(Myopia)</h4>
					  </div>
				    </div></ul>
				  
				  <ul><div class="option-eyesighthyperopia" style="clear:both;padding-top:10px;" >
				      <div class="option-backimg">
					      <img id="option-eyesightimg" class="option-tempimg" src = "/images/simulators/checkback1.png"  alt=""   onClick="setOption(2)"/> 
					  </div>
					  <div class="eyesight-text" style="margin-left:25px;">
					     <h4 class="option_title13" style="margin-bottom:0px;   text-shadow: rgb(0, 0, 0) 1px 1px 3px;">Perfect Eyesight</h4>
					  </div>
				    </div></ul>
				  <ul><div class="option-hyperopia" style="clear:both;padding-top:10px;">
				      <div class="option-backimg">
					      <img id="option-hyperopiaimg" class="option-tempimg" src = "/images/simulators/checkback1.png"  alt="" onClick="setOption(3)"/> 
					  </div>
					  <div class="hyperopia-text" style="margin-left:25px;">
					     <h4 class="option_title13" style="margin-bottom:0px;   text-shadow: rgb(0, 0, 0) 1px 1px 3px;">Far-sighted (Hyperopia)</h4>
					  </div>
				    </div></ul>	
				</div>
			 </div>
			 <div class="option-age">
			      <ul><h3 class="option_title12" style="      text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> AGE </h3></ul>
				  <ul><div class="option-40age" style="clear:both;">
					     <div style="float:left"><h4 class="option_title13" style="      text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> <40 </h4></div>
						 ...
						 <div style="float:left; margin-left:22px;"><h4 class="option_title13" style="     text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> >40</h4></div>
					 </div>
				  </ul>
				  <ul><div class="option-single" style="clear:both;padding-top:10px;">
					     <div class="option-backimg">
						    <img id="check-single" class="option-tempimg" style=""src = "/images/simulators/check1.png"  alt="" onclick="setchecklens(0)"/>                             							
						 </div >
						 <div style="float:left;margin-left:5px;"><h4 style="margin-bottom:0px;   text-shadow: rgb(0, 0, 0) 1px 1px 3px;" class="option_title13" style="    ">Default Single Vision Lens</h4></div>  
					 </div>
				  </ul>
				  <ul><div class="option-progress" style="clear:both;padding-top:10px;">
					     <div class="option-backimg">
						    <img id="check-progressive" class="option-tempimg" style=""src = "/images/simulators/check_back.png"  alt="" onclick="setchecklens(1)"/>                             							
						 </div >
						 <div style="float:left;margin-left:5px;"><h4 style="margin-bottom:0px;   text-shadow: rgb(0, 0, 0) 1px 1px 3px;" class="option_title13" style="    ">With Progressive Lens(40+)</h4></div>  
					 </div>
				  </ul>
			 </div>
			 <div class="option-lifestyle">
			      <ul><h3 class="option_title12" style="     text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> LIFESTYLE </h3></ul>
				  <ul><div class="option-inout">
				        <div style="float:left"><h4 class="option_title13" style="      text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> Indoor</h4></div>
						 ...
						 <div style="float:left;margin-left:15px;"><h4 class="option_title13" style="     text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> Outdoor</h4></div> 
					  </div>
				  </ul>
			 </div>
			 
			 <div class="option-treat">
			      <ul><h3 class="option_title12" style="      text-shadow: rgb(0, 0, 0) 1px 1px 3px;"> TREATMENTS </h3></ul>
				  <ul><div class="option-BC" style="clear:both;margin-top:10px;">
				        <div style="float:left; position:relative;">
						    <img class="option-tempimg" src = "/images/simulators/check_enable.png" style="    margin-top: 1px;    margin-left: 1px;     width: 21px;"  alt="" onclick="setcheckBC(1)"/> 
						    <img class="option-tempimg option-classimg" id="check-BC" style="position:absolute; top:1px;left:1px;"src = "/images/simulators/check.png"  alt="" onclick="setcheckBC(0)"/> 
						 </div>
						 <div style="float:left;margin-left:5px;"><h4 class="option_title13" style="      text-shadow: rgb(0, 0, 0) 1px 1px 3px;">WITH BLUECONTROL</h4></div>  
				  ...
				  <ul><div class="option-PC">
				      <div class="option-progress" style="clear:both;padding-top:10px;">
					     <div style="float:left; position:relative;">
						    <img class="option-tempimg" src = "/images/simulators/check_back.png" style="    margin-top: 1px;    margin-left: 1px;     width: 21px;"  alt="" />
                            <img class="option-tempimg" id="check-PCenable" style="position:absolute; top:1px;left:1px;"src = "/images/simulators/check_enable.png"  alt="" onclick="setcheckPC(1)"/>                             							
						    <img class="option-tempimg" id="check-PC" style="position:absolute; top:1px;left:1px;"src = "/images/simulators/check.png"  alt="" onclick="setcheckPC(0)"/> 
						  </div>
						 <div style="float:left;margin-left:5px;"><h4 class="option_title13" style="    text-shadow: rgb(0, 0, 0) 1px 1px 3px;">WITH PHOTOCHROMICS</h4></div>  
					   </div>
					  </div>
				  </ul>
			 </div>
			 ...
			 <div class="option-simulate-btn">
			    <ul><div id="suggested-btn" style="float:left; position:relative; margin-top:30px;margin-bottom:30px;left:-20px; cursor:pointer">
					 ...
					 <h4  style="position:absolute;top:0px;" class="option_title14" style="    text-shadow: rgb(0, 0, 0) 1px 1px 3px;">VIEW SUGGESTED LENS</h4>
				    </div>
				 </ul>
			 </div>
		...
		<div id="suggested-lens" style="position:relative">
		    ...
		    <div class="suggested-content" style="width:100%;float:right;position:absolute;left:0px;top:0px;">
				...
				<div id="fp_iconpart_1" style="position:absolute;width:45%;margin-left:55%;margin-top:100px;display:none">
			        <ul>
						...
						<li class="icon_li" style="margin-bottom:5px;margin-top:0px"><img class="selicon" src="/images/products/p_nulux_identity_V+.svg" onclick="popup_content(4)" alt="" /></li>
					...
					<ul>
						...
						<li class="icon_li" style="margin-bottom:5px;margin-top:0px"><img class="selicon" style="cursor:pointer" src="/images/products/h_longlife.svg" onclick="popup_content(17)" alt=""></li>
					</ul>
					<ul>
					   <li class="icon_li option31" style="margin-left:0px;margin-bottom:5px;margin-top: -5px;padding-right: 5px;"><img class="selicon1" src="/images/products/h_bluecontrol.svg" alt=""  onclick="popup_content(18)"/></li>
				       <li class="icon_li option32" style="margin-bottom:5px;margin-top: 10px;padding-right: 5px;"><img class="selicon1" src="/images/products/p_sensity.svg" onclick="popup_content(19)" alt="" /></li>
				       <li class="icon_li option32" style="margin-bottom:5px;margin-top: 0px;"><img class="selicon1" src="/images/products/p_transitions.svg" onclick="popup_content(20)" alt="" /></li>
                    </ul>
		        </div>
				
		        <div id="fp_iconpart_2" style="position:absolute;width:45%;margin-left:55%;margin-top:100px;display:block">
			        <ul>
				       <li class="icon_li" style="margin-bottom:5px;padding-right: 35px;"><img class="selicon1" src="/images/products/p_summitdynamic.svg" onclick="popup_content(6)" alt="" /></li>
					   <li class="icon_li" style="margin-bottom:5px;padding-right: 35px;"><img class="selicon1" src="/images/products/p_summit_procd.svg" onclick="popup_content(7)" alt="" /></li>
					   <li class="icon_li" style="margin-bottom:5px;padding-right: 35px;"><img class="selicon1" src="/images/products/p_summit_trueform.svg" onclick="popup_content(8)" alt="" /></li>
					   <li class="icon_li" style="margin-bottom:5px;"><img class="selicon1" src="/images/products/p_hoyalux_id.svg" onclick="popup_content(11)" alt="" /></li>
					</ul>
			        <ul>
					   <li class="icon_li" style="margin-bottom:5px;padding-right: 35px;"><img  class="selicon1" src="/images/products/p_hoyalux_mystyle_v+.svg" onclick="popup_content(13)" alt="" /></li> 
				       <li class="icon_li" style="margin-bottom:5px;padding-right: 35px;"><img class="selicon1" style="cursor:pointer" src="/images/products/h_longlife.svg" onclick="popup_content(17)" alt=""></li>
					   <li class="icon_li" style="margin-bottom:5px;padding-right: 35px;"><img class="selicon1" src="/images/products/p_trinity.svg" onclick="popup_content(12)" alt="" /></li>
					   <li class="icon_li" style="margin-bottom:5px;"><img class="selicon1" src="/images/products/p_hoyalux_lifestyle_v+.svg" onclick="popup_content(10)" alt="" /></li>
					</ul>
			        <ul>
					    <li class="icon_li" style="margin-bottom:5px;padding-right: 35px;"><img class="selicon1" src="/images/products/p_hoyalux_fd.svg"  onclick="popup_content(9)" alt="" /></li>
				        <li class="icon_li" style="margin-bottom:5px;padding-right: 35px;"><img class="selicon1" src="/images/products/p_hoyalux_workstyle.svg" onclick="popup_content(16)" alt="" /></li>
					...
					<ul>
					   <li class="icon_li option31" style="margin-left:0px;margin-bottom:5px;margin-top: 0px;padding-right: 5px;"><img class="selicon1" src="/images/products/h_bluecontrol.svg" alt=""  onclick="popup_content(18)"/></li>
				       <li class="icon_li option32" style="margin-bottom:5px;margin-top: 10px;padding-right: 5px;"><img class="selicon1" src="/images/products/p_sensity.svg" onclick="popup_content(19)" alt="" /></li>
				       <li class="icon_li option32" style="margin-bottom:5px;margin-top: 0px;"><img class="selicon1" src="/images/products/p_transitions.svg" onclick="popup_content(20)" alt="" /></li>
                    </ul>
		        </div>
				<!--<div id="fp_iconpart_3" style="position:relative;width:50%;margin-left:55%">
			        <ul>
					   <li class="icon_li1 option31" style="margin-left:0px;margin-bottom:5px;margin-top: 0px;padding-right: 5px;"><img class="selicon" src="/images/products/h_bluecontrol.svg" alt=""  onclick="popup_content(18)"/></li>
				       <li class="icon_li1 option32" style="margin-bottom:5px;margin-top: 10px;padding-right: 5px;"><img class="selicon" src="/images/products/h_sensity.svg" onclick="popup_content(19)" alt="" /></li>
				       <li class="icon_li1 option32" style="margin-bottom:5px;margin-top: 0px;"><img class="selicon" src="/images/products/h_transition.svg" onclick="popup_content(20)" alt="" /></li>
                    </ul>
		        </div>-->
				
				<div class="suggested_text3" style="position:absolute;width:43%;margin-left:55%">
				    <h3 class="text3_font">Disclaimer:<br/>The above suggested lenses are results based on a basic simulation. For more accurate result, please visit our authorised ECP and seek for professional advice.</h3>
				</div>
            </div>		
            </div>			
		</div>
	 ...
	 function popup_content(sel_v){
		...
		function PositionOption(){
			 ...
			 var screenwidth = window.innerWidth;
				 ...
				 hh = Math.round(550 * (screenwidth * 1.0 / 1920.0));
				 if(hh < 200){
					 hh = 200;
				 }
				 ...
				 if(screenwidth > 1650)
					 $('.option_title14').css("font-size","15px").css("padding-top","6px").css("padding-left","25px");
				 else if(screenwidth > 1400)
					     $('.option_title14').css("font-size","14px").css("padding-top","6px").css("padding-left","30px");
					  else if(screenwidth > 950)
						       $('.option_title14').css("font-size","12px").css("padding-top","6px").css("padding-left","40px");
					       else if(screenwidth > 800){
							        $('.suggestimg').css("width",Math.round(200 * screenwidth * 1.0 / 800.0)-10+"px");
					                $('.option_title14').css("font-size","11px").css("padding-top","5px").css("padding-left",Math.round(45 * screenwidth * 1.0 / 1000.0)+"px");				 
						   }else{
							     $('.suggestimg').css("width","175px");
					             $('.option_title14').css("font-size","11px").css("padding-top","3px").css("padding-left","23px");				 
						   }
				 			 
				 if(screenwidth < 600){
					 $('.optionbar-bind').css("left","10px");
					 $('.option_title13').css("padding-top","0px").css("padding-left","12px");
					 $('.optionback1').css("height","20px");
					 $('.optionback2').css("height","20px");
					 $('.optionback2').css("margin-top","2px");
					 $('#suggested-btn').css("left","0px");
					 $('#check-BC').css("top","5px");
					 $('#check-PCenable').css("top","5px");
					 $('#check-PC').css("top","5px");
					 
				 }else if(screenwidth < 900){
					 $('.optionbar-bind').css("left","30px");
					 $('.optionback1').css("height","30px");
					 $('.optionback2').css("height","30px");
					 $('.optionback2').css("margin-top","0px");
					 $('#check-BC').css("top","1px");
					 $('#check-PCenable').css("top","1px");
					 $('#check-PC').css("top","1px");
					 $('#check-BC').css("top","3px");
					 $('#check-PCenable').css("top","3px");
					 $('#check-PC').css("top","3px");
				 }else{
					 $('.optionbar-bind').css("left","30px");
					 $('.optionback1').css("height","30px");
					 $('.optionback2').css("height","30px");
				 ...
				 $('#fp_iconpart_1').css("margin-top",hh+15+"px");
				 $('#fp_iconpart_2').css("margin-top",hh+25+"px");
				 ...
				 hh = Math.round(18 * screenwidth * 1.0 / 1400.0);
				 if(hh < 7) hh = 7;
				 $('.text3_font').css("font-size",hh+"px");
				 ...
				 ff = Math.round(22 * screenwidth * 1.0 / 1000.0);	
				 
				 if(ff < 14) ff=14;
				 if(ff > 22) ff = 22;
				 $('.option-tempimg').css("width",ff+"px");
