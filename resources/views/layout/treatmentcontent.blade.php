...
window.addEventListener('resize', function(event) {
	...
	<script type="text/javascript">
		 ...
		 function selARoption(){
			 switch(selARflag){
			     case 0: document.getElementById("optionbar_AR").style.transform="translate("+"+"+""+transval+"px,0)";
		...
		function positionOption(){
			 ...
			 if(ff1 > 40)ff1 = 40;
			 transval = ff-18-ff1;
			 $('#optionbar_AR').css("transform","translate("+transval+"px, 0px)");
			 ...
			 if(ff > 44)ff = 44;
			 $('#optionbar_AR').css("width",ff+"px");
			 $('#optionbar_AR').css("margin-top","4px");
...
<div class="container_about" style="width:100%;position:relative;">
    ...
    <div class="container container-simulator" style="z-index:50;display:none">
            ...
            <div id="pop_single_AR" style="width: 550px;">
            	<ul>
                	<li><p class="optiontext" style="margin-left:-5px;text-shadow: rgb(0, 0, 0) 1px 1px 3px;">WITHOUT BLUE CONTROL</p></li>
                    <li style="margin-left: 5px;">
                    	<div class="optionimg" onclick="selARoption()" style="background-repeat: no-repeat;    background-size: contain;">
	                        <img id="optionbar_AR"src="/images/products/optionbar_sel_1.png" alt=""/>
                        </div>
                    </li>
                    <li style="margin-left: 10px;"><p class="optiontext" style="margin-left: 5px;text-shadow: rgb(0, 0, 0) 1px 1px 3px;">WITH BLUE CONTROL</p></li>
                </ul>
            	<ul>
                	<li><p class="optiontext" style="margin-left:0px;text-shadow: rgb(0, 0, 0) 1px 1px 3px;">AR treatment reduce eyestrain and fatigue caused by blue light waves.<br/>(which you're string at right now)</p></li>
                </ul>
            </div>
    </div>
