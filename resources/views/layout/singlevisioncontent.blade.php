...
<script src="/js/bootstrap.min.js"></script>
	...
	<script src="js/zoomple1.js" type="text/javascript"></script>   
	 ...
	 <script type="text/javascript">
		 ...
		 function seloption(){
			 switch(selflag){
			     case 0: document.getElementById("optionbar_sel_1").style.transform="translate("+"+"+""+transval+"px,0)";
		...
		function screenset(){
			...
			if(screenwidth > 800){
			 ...
			 if(ff1 > 40)ff1 = 40;
			 transval = ff-18-ff1;
			 $('#optionbar_sel_1').css("transform","translate("+transval+"px, 0px)");
			 ...
			 if(ff > 44)ff = 44;
			 $('#optionbar_sel_1').css("width",ff+"px");
			 $('#optionbar_sel_1').css("margin-top","4px");
...
<div class="container_about" style="width:100%;position:relative">
    ...
    <div class="container container-simulator" style="z-index:50; min-width:400px;display:none">
            ...
            <div id="pop_single_reg" style="width: 550px;">
            	<ul>
                	<li><p class="optiontext">MYOPIA<br/>(SHORT-SIGHTNESS)</p></li>
                    <li>
                    	<div class="optionimg" onclick="seloption()" style="background-repeat: no-repeat;    background-size: contain;">
	                        <img id="optionbar_sel_1"src="/images/products/optionbar_sel_1.png" alt=""/>
                        </div>
                    </li>
                    <li><p class="optiontext">HYPEROPIA<br/>(FAR-SIGHTNESS)</p></li>
                </ul>
            	<ul>
                	<li><p class="optiontext" style="margin-left:60px">How HOYA Single Vision lenses improve your vision.</p></li>
                </ul>
            </div>
    </div>
