...
<div class="container" id="bg_img" style="background-image: url(../images/contactus/105101.jpg);height:700px;background-position:center;background-repeat:no-repeat;min-width:100%;background-size:cover; ">
	<h1 class="font_1" id="htxt_center" >Contact Us</h1>
	<address class="txt_center" >				
				<h2 class="txt_bold"> <b>Address</b></h2>
					<h2 class="txt_thin">Malaysian Hoya Lens Sdn. Bhd. <br>
	...
	<div class="col-md-4 map-content"   style="margin-left:7%;margin-top:3%;">
		<address id="disnone">				
			<p style="font-size:20px;"> <b>Address</b></p>
				<p style="font-size:20px;">Malaysian Hoya Lens Sdn.Bhd <br>
						NO.6, Jalan7/32A, Off 6 1/2Miles,<br>
						Jalan Kepong,<br>
						52000 Kuala Lumpur,<br>
						Malaysia
				...
				<p style="font-size:20px;"><b>Email</b></h5>
					<p style="font-size:20px;">contact@hoya.com.my</p>
		</address>
	</div>
...
<div class="container" id="disnone" style="width:100%;position:relative;height:456px;">
	<div class="gmap"> 
	    <iframe
		  ...
		  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyD7xXdoWIKwiKgIEy0RFv4tkqdtH9tnmmI&q=Malaysia Hoya Lens Sdn. Bhd" allowfullscreen>
		</iframe>
