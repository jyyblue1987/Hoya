	 ...
	 function popup_content(sel_v){			
		...
		function screenset(){
			 ...
			 if(screenwidth > 800){
				 ...
				 var x = screenwidth/4 -2;
					$('.titlesvg').css("width",x+"px").attr("width",x+"px");
...
<div class="container_about" style="width:100%;position:relative;">
	...
	<div class="row active" style=" background-image:url(/images/products/progressive_back3.png); background-position:center top; background-size:cover;">
        ...
        <div class="about_cnt_2">
            <div id="pg_textpart" style="margin-left:0px;width:50%">
                <ul class="titlesvg1" style="    margin-bottom: 30px; ">
            ...
            <div id="pg_iconpart" style="margin-left:0px;width:50%">
                <ul class="titlesvg1" style="    width: 100%;">
                    <li class="titlesvg"><img class="svg2" src="/images/products/h_summitPT.svg" style="height:60px;" onclick="popup_content(1)" alt="" ></li>
                    <li class="titlesvg"><img class="svg2" src="/images/products/h_lux_id.svg" style="height:60px;" onclick="popup_content(2)" alt=""></li>
                    <li class="titlesvg"><img class="svg2" src="/images/products/h_lux_trinity.svg" style="height:60px;" onclick="popup_content(3)" alt=""></li>
					<li class="titlesvg"><img class="svg2" src="/images/products/h_mystyleid.svg" style="height:60px;" onclick="popup_content(4)" alt=""></li>
                </ul>
                <ul class="titlesvg1" style="    width: 80%;">
                    <li class="titlesvg"><img class="svg2" src="/images/products/h_summit_pro.svg" style="height:60px;" onclick="popup_content(5)" alt=""></li>
                    <li class="titlesvg"><img class="svg2" src="/images/products/selicon_19.svg" style="height:60px;" onclick="popup_content(6)" alt=""></li>
                </ul>
                <ul class="titlesvg1" style="    width: 80%;">
				    <li class="titlesvg"><img class="svg2" src="/images/products/h_summitdynamic.svg" style="height:60px;" onclick="popup_content(7)" alt=""></li>
					<li class="titlesvg"><img class="svg2" src="/images/products/h_lux_fd.svg" style="height:60px;" onclick="popup_content(8)" alt=""></li>
                </ul>
            </div>
        </div>
	</div>
 ...
 <div id="progressive_1" class="detailpop fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="detailpop-dialog" style="width:63%;   height:auto">
		<div class="detailpop-content" style="background-color:white">
			...
			<img class="popup_iconimg" src="/images/products/h_summitPT.svg" alt="" />
  ...
  <div id="progressive_2" class="detailpop fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="detailpop-dialog" style="width:63%;height:auto">
		<div class="detailpop-content" style="background-color:white">
			...
			<img class="popup_iconimg" src="/images/products/h_lux_id.svg" alt="" />
			<div style="position:absolute;top:0px;right:0px"class="detailpop-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="detailpop-body detailpop-header">
				<div id="detail_pop_content" class="contentdial">
					<ul style="width:80%">
                        ...
                        <li class="p_title1">Hoyalux iD is the world’s first Intefrated Double Surface Design that imposes no limitations on the weareyalux iD integrates the best of both worlds: a wide, distortion-free field of vision at all distances and fast interaction between far and near.</li></li>
                        <li class="p_subject">Key Technologies</li>
                        <li class="p_title2">Integrated Double Surface Design</li>
						...
						<li class="p_subject">Benefits</li>
						<li class="p_title2">An extremely clear, natural vision in all directions and distances</li>
						<li class="p_title2">Smooth switching from far to near</li>
						<li class="p_title2">Widest possible field of vision</li>
						<li class="p_title2">Unsurpassed feeling of comfort</li>
						<li class="p_title2">100% stability when moving around</li>
                        <li class="logo_link"><img class="bottomlog" src="/images/popup/logo_blue.svg" /></li>
					</ul>
				</div>
			</div>
  ...
  <div id="progressive_3" class="detailpop fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="detailpop-dialog" style="width:63%;height:auto">
		<div class="detailpop-content" style="background-color:white">
			...
			<img class="popup_iconimg" src="/images/products/h_lux_trinity.svg" alt="" />
			<div style="position:absolute;top:0px;right:0px"class="detailpop-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="detailpop-body detailpop-header">
  ...
  <div id="progressive_4" class="detailpop fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="detailpop-dialog" style="width:63%;height:auto">
		<div class="detailpop-content" style="background-color:white">
			...
			<img class="popup_iconimg" src="/images/products/h_mystyleid.svg" alt="" />
			<div style="position:absolute;top:0px;right:0px"class="detailpop-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="detailpop-body detailpop-header">
  ...
  <div id="progressive_5" class="detailpop fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="detailpop-dialog" style="width:63%;height:auto">
		<div class="detailpop-content" style="background-color:white">
			...
			<img class="popup_iconimg" src="/images/products/h_summit_pro.svg" alt="" />
			<div style="position:absolute;top:0px;right:0px"class="detailpop-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="detailpop-body detailpop-header">
  ...
  <div id="progressive_7" class="detailpop fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="detailpop-dialog" style="width:63%;height:auto">
		<div class="detailpop-content" style="background-color:white">
			...
			<img class="popup_iconimg" src="/images/products/h_summitdynamic.svg" alt="" />
			<div style="position:absolute;top:0px;right:0px"class="detailpop-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="detailpop-body detailpop-header">
  ...
  <div id="progressive_8" class="detailpop fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="detailpop-dialog" style="width:63%;height:auto">
		<div class="detailpop-content" style="background-color:white">
			...
			<img class="popup_iconimg" src="/images/products/h_lux_fd.svg" alt="" />
			<div style="position:absolute;top:0px;right:0px"class="detailpop-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="detailpop-body detailpop-header">
				<div id="detail_pop_content" class="contentdial">
					<ul style="width:80%">
                        ...
                        <li class="p_title1">The Hoyalux FD lens offers a semi-customized progressive design, with the prescription partially shaped on the front and fully customized on the back to provide a noticeably clearer view in every direction. It utilizes Hoya’s patented Integrated Double Surface Design Technology to analyze eye rotation in order to map a unique lens design. </li>
                        <li class="p_subject">Key Technologies</li>
                        <li class="p_title2">Combining Integrated Double Surface Design Technology with a standardize front surface component</li>
                        <li class="p_title2">Ergonomic inset customisation based on near prescription, pupillary distance and near working distance.</li>
                        <li class="p_title2">Corridor length options for different visual needs ( 11mm & 14mm)</li>
                        <li class="p_title2">Addition Power Definition for optimised reading experience (Front / Back / As Worn )</li>
						<li class="p_subject">Benefits</li>
						<li class="p_title2">Follows the natural eyeball rotation for easier adaptation</li>
						<li class="p_title2">Smooth switching from far to near</li>
						<li class="p_title2">Unsurpassed feeling of comfort</li>
						<li class="p_title2">Secure feeling when moving around</li>
                        <li class="logo_link"><img class="bottomlog" src="/images/popup/logo_blue.svg" /></li>
