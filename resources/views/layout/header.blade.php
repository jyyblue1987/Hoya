...
<!--******************************************************************************************************-->				
				<div class="footer_block">
					...
					<ul style="   margin-top: 25px;">
						...
						<li><a href="/lens" aria-hidden="true">Single vision</a></li>
						<li><a href="/lens" aria-hidden="true">Progressive Lens</a></li>
						<li><a href="/lens" aria-hidden="true">Occupational Lens</a></li>
					</ul>
				</div>
				<div class="footer_linespacing">
					<img src="/images/products/sepearate_line.png"/>
...
<!--******************************************************************************************************-->				
				<div class="footer_block">
					...
					<ul style="    margin-top: 25px;">
						...
						<li><a href="/lens" aria-hidden="true">Anti Reflection</a></li>
                        <li><a href="/lens" aria-hidden="true">Photochromics</a></li>
					</ul>
				</div>
				<div class="footer_linespacing">
					<img src="/images/products/sepearate_line.png"/>
...
<!--******************************************************************************************************-->				
				<div class="footer_block">
					...
					<ul style="    margin-top: 25px;">
						<li style="font-weight:bold; cursor:default"><a href="/lens" aria-hidden="true">LENS MATERIALS</a></li>
						<li>
							<a href="#" style="margin-right: 10px;left:0px" onclick="show_material_popup('/lens', 1)">&nbsp1.50&nbsp&nbsp</a>
							<a  href="#" onclick="show_material_popup('/lens', 4)">&nbsp1.67&nbsp</a>
						</li>
						<li>
							<a href="#" style="margin-right: 10px;left:0px" onclick="show_material_popup('/lens', 2)">&nbsp1.53&nbsp</a>
							<a  href="#" onclick="show_material_popup('/lens', 5)">&nbsp&nbsp1.70&nbsp</a>
						</li>
						<li>
							<a  href="#" style="margin-right: 10px;left:0px" onclick="show_material_popup('/lens', 3)">&nbsp1.60&nbsp&nbsp</a>
							<a  href="#" onclick="show_material_popup('/lens', 6)">&nbsp1.74&nbsp</a>
						</li>
					</ul>
				</div>
			</div>
    ...
    <!-- Navigation -->
    <nav id="id_naverbar" class="navbar navbar-inverse nava-fixed-top" role="navigation" style="z-index:2020">
        <div class="container containernab" style="height:90px;">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse webnavbar">
                <ul class="nav navbar-nav navbar-right webnavbar" style="text-align:center">
					<li><a href="/lens" onmouseover="popup_winHide()">ABOUT US</a></li>
					...
					<li><a href="/lens" onmouseover="popup_winHide()">CAREER</a></li>
					<li><a href="/lens" onmouseover="popup_winHide()">CONTACT US</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right mobilenavbar" style="text-align:left; background-color:#000;width:70%; margin-left:30%;margin-top:0px;overflow:scroll;height:400px;    opacity: 0.8;overflow-y:scroll;">
					<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:10%;"><a href="/lens">ABOUT US</a></li>
					<li id="product_menu" style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:10%;"><a href="#" id="product_menu_a">PRODUCTS</a></li>
						<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;font-weight:bold;padding-left:20%;"><a href="/lens" aria-hidden="true">FULL PRODUCT RANGE</a></li>
						...
						<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:24%;"><a href="/lens" aria-hidden="true">Single vision</a></li>
						<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:24%;"><a href="/lens" aria-hidden="true">Progressive Lens</a></li>
						<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:24%;"><a href="/lens" aria-hidden="true">Occupational Lens</a></li>
						...
						<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:24%;"><a href="/lens" aria-hidden="true">Anti Reflection</a></li>
                        <li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:24%;"><a href="/lens" aria-hidden="true">Photochromics</a></li>
						...
						<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:24%;">
							<a href="#" style="margin-right: 10px;left:0px;float:left" onclick="show_material_popup('/lens', 1)">&nbsp1.50&nbsp;&nbsp;</a>
							<a  href="#" onclick="show_material_popup('/lens', 4)">&nbsp;1.67&nbsp;</a>
						</li>
						<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:24%;">
							<a href="#" style="margin-right: 10px;left:0px;float:left" onclick="show_material_popup('/lens', 2)">&nbsp;1.53&nbsp;</a>
							<a  href="#" onclick="show_material_popup('/lens', 5)">&nbsp;&nbsp;1.70&nbsp;</a>
						</li>
						<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:24%;">
							<a  href="#" style="margin-right: 10px;left:0px;float:left" onclick="show_material_popup('/lens', 3)">&nbsp;1.60&nbsp;&nbsp;</a>
							<a  href="#" onclick="show_material_popup('/lens', 6)">&nbsp;1.74&nbsp;</a>
						</li>
					...
					<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:10%;"><a href="/lens">CAREER</a></li>
					<li style="border-bottom-color:#fff;border-bottom-style: groove;border-bottom-width: 1px;padding-left:10%;"><a href="/lens">CONTACT US</a></li>
                </ul>
            </div>
        </div>
    </nav>    
