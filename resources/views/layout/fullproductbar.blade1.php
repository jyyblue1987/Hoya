...
<div class="container_about" style="width:100%;position:relative;">
	...
	<div id = "" class="aboutdivid" style=" background-image:url(../uploads/{{$users[0]['thumbpath']}}); background-position:left top; background-size:cover; height:827px;min-width:100%">
		...
		<div id="fp_iconpart_1" style="width:50%;margin-left:50%">
			<ul>
				...
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/products/selicon-4.png" onclick="popup_content(4)" alt="" /></li>
	...
	<div id = "" class="aboutdivid" style=" background-image:url(../uploads/{{$users[1]['thumbpath']}}); background-position:right top; background-size:cover; height:828px;min-width:100%">
		...
		<div id="fp_iconpart_2" style="margin-left:3%">
			<ul>
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/popup/summit_dynamic.png" style="height:60px;" onclick="popup_content(6)" alt="" /></li>
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/popup/summit_procd.png" style="height:60px;" onclick="popup_content(7)" alt="" /></li>
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/products/selicon_44.svg" style="height:60px;" onclick="popup_content(8)" alt="" /></li>
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/products/selicon_51.svg" style="height:60px;" onclick="popup_content(9)" alt="" /></li>
			</ul>
			<ul>
				...
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/products/selicon_11.svg" style="height:60px;" onclick="popup_content(11)" alt="" /></li>
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/products/selicon_10.svg" style="height:60px;" onclick="popup_content(12)" alt="" /></li>
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/products/selicon-16.png" style="height:60px;" onclick="popup_content(13)" alt="" /></li>
			</ul>
	...
	<div id = "" class="aboutdivid" style=" background-image:url(../uploads/{{$users[2]['thumbpath']}}); background-position:left top; background-size:cover; height:824px;min-width:100%">
		...
		<div id="fp_iconpart_3" style="width:50%;margin-left:50%">
			<ul>
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/products/selicon-17.png"  onclick="popup_content(19)" alt="" /></li>
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" src="/images/products/selicon-18.png"  onclick="popup_content(20)" alt="" /></li>
	...
	<div id = "" class="aboutdivid" style=" background-image:url(../uploads/{{$users[3]['thumbpath']}}); background-position:right top; background-size:cover; height:832px;min-width:100%">
		...
		<div id="fp_iconpart_4" style="width:50%;margin-left:10% ;   padding-top: 50px;">
			<ul>
				...
				<li class="icon_li" style="margin-bottom:5px;"><img class="svg1" class="svg1" src="/images/products/selicon_13.svg" style="height:72px;" onclick="popup_content(16)" alt="" /></li>
			</ul>
		</div>
	</div>
</div>
