	...
	<script type="text/javascript">
		...
		$(document).on("click", "#treatment_part", function (e) {
		 ...
		 $(function(){ 
			 ...
			 selARoption();
			 //$('#zoomover').attr("src","/models/timthumb.php?src=/images/products/AR.jpg&w="+imgw+"&h="+imgh);
...
<div class="container_about" style="width:100%;position:relative;">
	...
	<div id="treatment_part" class="row active" style="position:relative;z-index:201;background-image:url(/images/products/products_back3.png); background-position:center top; background-size:cover; height:604px;">
	   <div style="float:left;"><img id="ar_icon_1"  style="" src = "images/products/ar_icon_1.png" alt=""/>	</div>
	   <div style="    right: 0px;  text-align: right;   position: absolute;"><img id="ar_icon_2"  style="" src = "images/products/ar_icon_2.png" alt=""/>	</div>
	</div>
<!--********************************************************************************************************************
***************************************** POP UP window ****************************************************************
**********************************************************************************************************************-->
			...
			<div class="detailpop-body detailpop-header">
				<div id="detail_pop_content" class="contentdial">
					<ul style="width:80%">
						...
						<li style="list-style-type:none"><img class="bottomlog12" style="position: absolute;right:40px;width:200px;top:190px;"src="/images/popup/AR_object.jpg" /></li>
						<li style="list-style-type:none"><img class="bottomlog13" style="position: absolute;right:20px;top:400px;width:270px;"src="/images/popup/AR_logo.jpg" /></li>
